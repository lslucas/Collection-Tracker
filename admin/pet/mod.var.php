...
#UPLOAD DE ARQUIVOS
    ...
    $var['imagem_folderlist'] = $var['path_imagem'].','.$var['path_original'].','.$var['path_thumb'].','.$var['path_big'];




    $field  = array('pet_nome', 'pet_codigo', 'pet_data', 'pet_url', 'pet_texto', 'pet_status', 'pet_id');
