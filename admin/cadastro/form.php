  <div class='error container-error'><div class='error-icon'>
	...
	<ol> 
		...
		<li><label for="login" class="error-validate">Tem que informar o login</label></li> 
...
-->
	...
	<li>	
	  <label>Login *<span class='small'>Login do cadastrado</span></label>
	  <input type='text' name='login' id='login' class='required' value='<?=$val['login']?>'>
	</li>
